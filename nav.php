...
<?php if (empty($_SESSION['Admin'])) { ?>
    ...
    <?php if($Username != null){echo '<li><a href="Cart.php" class="' . (($current_page == "Cart.php") ? "Acc" : "") . '">Cart <i class="fa-solid fa-cart-shopping"></i> </a></li>';} ?>
    <?php if($Username == null){echo '<li><a href="register.php?ActionType=Register" class="' . (($current_page == "register.php") ? "Acc" : "") . '">Register</a></li>';} ?>
    <?php 
        if ($Username == null) {
