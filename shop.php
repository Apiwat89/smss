    ...
    <div class="container">
		...
		<div class="col-sm-4 col-lg-4 col-md-4">
             <div class="thumbnail">
				...
				<center><a class="add" onclick="addToCartOnclick('.$Rows[0].');" href="#"  style="margin-bottom: 5px;" class="btn btn-primary">Add to Cart</a></center>
            </div>
        </div>
		';
		}?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
					...
					<br>
					<strong>
					<?php if($Username == null){echo '<a href="Login.php">Login</a>';} else {echo '<a href="Logout.php">Logout</a>';} ?> | 
